...
class SortableOverlay extends StatelessWidget {
  SortableOverlay({
    required this.child,
  ...
  Widget build(BuildContext context) {
    return axisBuilder.buildGlobalPos(
      overlay: this,
      child: ClipRect(
...
abstract class AxisOverlayBuilder {
  ...
  Positioned buildGlobalPos({required SortableOverlay overlay, required Widget child});
  Positioned buildLocalPos({required SortableOverlay overlay, required Widget child});
